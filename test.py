...
<html>
  <head>
    ...
    <script type="text/javascript">var NREUMQ=[];NREUMQ.push(["mark","firstbyte",new Date().getTime()]);</script>
        <title>test.py at master from SMU-SIS/code-worker - GitHub</title>
  ...
  <link rel='canonical' href='/SMU-SIS/code-worker/blob/2715950050cbe39d6f0d7e8c57aea77daeaa3a1a/test.py'>
  ...
  <input type="text" spellcheck="false" class="url-field" />
        <span style="display:none" id="clippy_1833" class="url-box-clippy"></span>
      <span id="clippy_tooltip_clippy_1833" class="clippy-tooltip tooltipped" title="copy to clipboard">
      ...
      <param NAME="FlashVars" value="id=clippy_1833&amp;copied=&amp;copyto=">
      ...
      <embed src="https://gs1.wac.edgecastcdn.net/80460E/assets/flash/clippy.swf?v5"
             ...
             FlashVars="id=clippy_1833&amp;copied=&amp;copyto="
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
...
<div class="flash-messages"></div>
  ...
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="test.py/">
      <b><a href="/SMU-SIS/code-worker/tree/2715950050cbe39d6f0d7e8c57aea77daeaa3a1a">code-worker</a></b> / test.py       <span style="display:none" id="clippy_2254" class="clippy">test.py</span>
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_2254&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="https://gs1.wac.edgecastcdn.net/80460E/assets/flash/clippy.swf?v5"
             width="110"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_2254&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="test.py/" data-canonical-url="/SMU-SIS/code-worker/blob/2715950050cbe39d6f0d7e8c57aea77daeaa3a1a/test.py">
        
          <ul class="big-actions">
            
            <li><a class="file-edit-link minibutton" href="/SMU-SIS/code-worker/edit/__current_ref__/test.py"><span>Edit this file</span></a></li>
          </ul>
        ...
        <div id="files">
          <div class="file">
            <div class="meta">
              ...
              <ul class="actions">
                <li><a href="/SMU-SIS/code-worker/raw/master/test.py" id="raw-url">raw</a></li>
                
                  <li><a href="/SMU-SIS/code-worker/blame/master/test.py">blame</a></li>
                
                <li><a href="/SMU-SIS/code-worker/commits/master/test.py">history</a></li>
              </ul>
            </div>
...
<span id="L15" rel="#L15">15</span>
          ...
          <td width="100%">
                ...
                <div class="highlight"><pre><div class='line' id='LC1'><span class="c">#!/usr/bin/env python</span></div><div class='line' id='LC2'><span class="c"># -*- coding: utf-8 -*-</span></div><div class='line' id='LC3'><br/></div><div class='line' id='LC4'><span class="kn">import</span> <span class="nn">urllib2</span><span class="o">,</span> <span class="nn">json</span></div><div class='line' id='LC5'><span class="n">f</span> <span class="o">=</span> <span class="n">urllib2</span><span class="o">.</span><span class="n">urlopen</span><span class="p">(</span><span class="s">&#39;http://dl.dropbox.com/u/4972572/get_next_job&#39;</span><span class="p">)</span></div><div class='line' id='LC6'><span class="c">#f = urllib2.urlopen(&#39;http://www.reddit.com/.json&#39;)</span></div><div class='line' id='LC7'><br/></div><div class='line' id='LC8'><span class="n">jsonStr</span> <span class="o">=</span> <span class="n">json</span><span class="o">.</span><span class="n">load</span><span class="p">(</span><span class="n">f</span><span class="p">)</span></div><div class='line' id='LC9'><br/></div><div class='line' id='LC10'><span class="k">print</span> <span class="n">jsonStr</span></div><div class='line' id='LC11'><span class="k">print</span> <span class="n">jsonStr</span><span class="p">[</span><span class="s">&#39;repo&#39;</span><span class="p">]</span></div><div class='line' id='LC12'><span class="k">print</span> <span class="n">jsonStr</span><span class="p">[</span><span class="s">&#39;command&#39;</span><span class="p">]</span></div><div class='line' id='LC13'><span class="k">print</span> <span class="n">jsonStr</span><span class="p">[</span><span class="s">&#39;job_type&#39;</span><span class="p">]</span></div><div class='line' id='LC14'><span class="n">f</span><span class="o">.</span><span class="n">close</span><span class="p">()</span></div><div class='line' id='LC15'><br/></div></pre></div>
  ...
  <img src="https://gs1.wac.edgecastcdn.net/80460E/assets/images/modules/ajax/big_spinner_336699.gif" height="32" width="32">
    ...
    <div id="footer" class="clearfix">
      <div class="site">
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2011 <span id="_rrt" title="0.11273s from fe2.rs.github.com">GitHub</span> Inc. All rights reserved.</li>
