...
test_jobs = [{	'command':'python master/code-worker/tasks/pep8/pep8.py target --count -qq', 
		'target':'git@github.com:SMU-SIS/CodeComparison.git',
		'master':'git@github.com:SMU-SIS/CodeComparison.git',
		'jobType':'TEST',
		'workerReserved':'none'},
		...
		'workerReserved':'none'},
	     {	'command':'python master/code-worker/tasks/pep8/pep8.py target --count -qq', 
		'target':'git@github.com:SMU-SIS/StoryServer.git',
		'master':'git@github.com:SMU-SIS/StoryServer.git',
		'jobType':'TEST',
		'workerReserved':'none'},
	     {	'command':'python code-worker/tasks/clonedigger/clonedigger.py --fast target', 
		'target':'git@github.com:SMU-SIS/StoryServer.git',
		...
		'workerReserved':'none'},
	     {	'command':'python master/code-worker/tasks/pep8/pep8.py target --count -qq', 
		'target':'git@github.com:SMU-SIS/TournamentServer.git',
		'master':'git@github.com:SMU-SIS/TournamentServer.git',
		'jobType':'TEST',
		'workerReserved':'none'},
	     {	'command':'python code-worker/tasks/clonedigger/clonedigger.py --fast target', 
		'target':'git@github.com:SMU-SIS/TournamentServer.git',
		...
		'workerReserved':'none'},
	     {	'command':'python master/code-worker/tasks/pep8/pep8.py target --count -qq', 
		'target':'git@github.com:SMU-SIS/PivotalExpert.git',
		'master':'git@github.com:SMU-SIS/PivotalExpert.git',
		'jobType':'TEST',
		'workerReserved':'none'},
	     {	'command':'python code-worker/tasks/clonedigger/clonedigger.py --fast target', 
		'target':'git@github.com:SMU-SIS/PivotalExpert.git',
